...
import '../screens/player_matchday_detail_screen.dart';
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                'Team: ${player.iplTeam.isNotEmpty ? player.iplTeam : 'Unknown'} • MDs: ${player.matchdayPoints.length}/25',
